...
module.exports = {
    ...
    .addSubcommand(
        ...
        .addStringOption(
            ...
            .setRequired(true)
            .addChoices(
                { name: '⭐ Captcha Sistem', value: 'captcha' },
...
.setEmoji(`1058424419657195570`)
.setLabel("𝙑𝙀𝙍𝙄𝙁𝙄𝙆𝘼𝙎𝙄")            .setStyle(ButtonStyle.Success);

const captcha_channel = options.getChannel("captcha_channel")
const captcha_embed = new EmbedBuilder()          .setColor(client.mainColor)
.setTitle("⭐ VERIFIKASI INDOSANS")
.setDescription("• **Klik `Verifikasi` Untuk Verifikasi**\n• **Bot Akan Mengirim Kode Captha**\n• **Selesaikan Kode Captcha Tersebut**\n• **Dan Kirim Di DM Botnya Jangan Disini**\n\n`Note : Kode Huruf Kapital Semua`")
.setImage("https://media.discordapp.net/attachments/1055144150124740678/1058425271402905621/20221230_234355_0000.png")
...
{new: true, upsert: true})
            ...
            Response.setDescription("✅ Berhasil Setup Captcha Sistem")
